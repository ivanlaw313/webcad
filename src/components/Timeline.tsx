...
const META: Record<string, { icon: string; label: string; param: string; field: string; unit: string; fields?: FieldDef[] }> = {
  ...
  featpattern: { icon: 'pattern', label: '陣列（組）', param: 'X 数量', field: 'cols', unit: '', fields: [{ key: 'cols', label: 'X数量', unit: '' }, { key: 'rows', label: 'Y数量', unit: '' }, { key: 'dx', label: 'X间距', unit: 'mm' }, { key: 'dy', label: 'Y间距', unit: 'mm' }] },  // 特征级组阵列：一个节点含 N 个副本，改行列数即重建
  ...
  scale: { icon: 'scale', label: '縮放', param: '比例', field: 'factor', unit: '×', fields: [{ key: 'factor', label: '等比', unit: '×' }, { key: 'sx', label: '非等比X', unit: '×' }, { key: 'sy', label: '非等比Y', unit: '×' }, { key: 'sz', label: '非等比Z', unit: '×' }, { key: 'px', label: '基准X', unit: 'mm' }, { key: 'py', label: '基准Y', unit: 'mm' }, { key: 'pz', label: '基准Z', unit: 'mm' }] },  // T762
  ...
  transform: { icon: 'move', label: '移動', param: 'X', field: 'dx', unit: 'mm', fields: [{ key: 'dx', label: 'X', unit: 'mm' }, { key: 'dy', label: 'Y', unit: 'mm' }, { key: 'dz', label: 'Z', unit: 'mm' }, { key: 'rx', label: '绕X', unit: '°' }, { key: 'ry', label: '绕Y', unit: '°' }, { key: 'rz', label: '绕Z', unit: '°' }] },
