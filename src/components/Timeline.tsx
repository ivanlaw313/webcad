...
const META: Record<string, { icon: string; label: string; param: string; field: string; unit: string; fields?: FieldDef[] }> = {
  ...
  pattern: { icon: 'pattern', label: '阵列', param: 'X 数量', field: 'countX', unit: '', fields: [{ key: 'countX', label: 'X数量', unit: '' }, { key: 'countY', label: 'Y数量', unit: '' }, { key: 'countZ', label: 'Z数量', unit: '' }, { key: 'dx', label: 'X间距', unit: 'mm' }, { key: 'dy', label: 'Y间距', unit: 'mm' }, { key: 'dz', label: 'Z间距', unit: 'mm' }] },
  ...
  mirror: { icon: 'mirror', label: '镜像', param: '偏移', field: 'offset', unit: 'mm', fields: [{ key: 'plane', label: '对称面', unit: '', opts: [{ value: 'YZ', label: 'YZ（左右）' }, { value: 'XZ', label: 'XZ（前后）' }, { value: 'XY', label: 'XY（上下）' }] }, { key: 'offset', label: '面偏移', unit: 'mm' }] },
  loft: { icon: 'loft', label: '放样', param: '高度', field: 'height', unit: 'mm' },
  surfloft: { icon: 'loft', label: '曲面放样', param: '壁厚', field: 'wall', unit: 'mm', fields: [{ key: 'wall', label: '壁厚', unit: 'mm' }] },
  ...
  sweep: { icon: 'sweep', label: '扫掠', param: '半径', field: 'r', unit: 'mm' },
  ...
  pathpattern: { icon: 'pathpattern', label: '路径阵列', param: '数量', field: 'count', unit: '', fields: [{ key: 'count', label: '数量', unit: '' }] },
  ...
  cpattern: { icon: 'cpattern', label: '环形阵列', param: '数量', field: 'count', unit: '', fields: [{ key: 'count', label: '数量', unit: '' }, { key: 'angle', label: '总角度', unit: '°' }, { key: 'axis', label: '绕轴', unit: '', opts: [{ value: 'Z', label: 'Z 轴(水平面内)' }, { value: 'X', label: 'X 轴' }, { value: 'Y', label: 'Y 轴' }] }] },
  ...
  circPattern: { icon: 'cpattern', label: '环形阵列', param: '数量', field: 'count', unit: '', fields: [{ key: 'count', label: '数量', unit: '' }, { key: 'totalAngle', label: '总角度', unit: '°' }, { key: 'mode', label: '模式', unit: '', opts: [{ value: 'full', label: '完整 360°' }, { value: 'angle', label: '指定角度' }, { value: 'sym', label: '对称' }] }] },  // T757
