...
const META: Record<string, { icon: string; label: string; param: string; field: string; unit: string; fields?: FieldDef[] }> = {
  ...
  newbody: { icon: 'newbody', label: '新实体', param: '', field: '', unit: '' },
  ...
  bodyboolean: { icon: 'bodyboolean', label: '实体布尔', param: '目标#', field: 'target', unit: '', fields: [{ key: 'bop', label: '操作', unit: '', opts: [{ value: 'fuse', label: '合并' }, { value: 'cut', label: '切除' }, { value: 'common', label: '相交' }] }, { key: 'target', label: '目标实体#', unit: '' }] },
