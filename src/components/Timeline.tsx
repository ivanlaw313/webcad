...
const META: Record<string, { icon: string; label: string; param: string; field: string; unit: string; fields?: FieldDef[] }> = {
  ...
  thread: { icon: 'thread', label: '螺纹杆', param: '螺距', field: 'pitch', unit: 'mm', fields: [{ key: 'd', label: '直径Ø', unit: 'mm' }, { key: 'pitch', label: '螺距', unit: 'mm' }, { key: 'height', label: '高度', unit: 'mm' }] },
  ithread: { icon: 'hole', label: '内螺纹孔', param: '公称Ø', field: 'd', unit: 'mm', fields: [{ key: 'd', label: '公称Ø', unit: 'mm' }, { key: 'pitch', label: '螺距', unit: 'mm' }, { key: 'height', label: '深度', unit: 'mm' }, { key: 'x', label: '中心X', unit: 'mm' }, { key: 'y', label: '中心Y', unit: 'mm' }] },
  cylpatch: { icon: 'cylpatch', label: '曲面贴花', param: '深度', field: 'depth', unit: 'mm', fields: [{ key: 'ang', label: '角度位置', unit: '°' }, { key: 'arc', label: '角宽', unit: '°' }, { key: 'zc', label: '轴向中心', unit: 'mm' }, { key: 'h', label: '轴向高', unit: 'mm' }, { key: 'depth', label: '深度', unit: 'mm' }, { key: 'mode', label: '模式', unit: '', opts: [{ value: 'boss', label: '凸台' }, { value: 'pocket', label: '凹槽' }, { value: 'flat', label: '锉平面' }] }] },
  ...
  gear: { icon: 'gear', label: '齿轮', param: '模数', field: 'module', unit: 'mm', fields: [{ key: 'module', label: '模数', unit: 'mm' }, { key: 'teeth', label: '齿数', unit: '' }, { key: 'thickness', label: '厚度', unit: 'mm' }, { key: 'bore', label: '中心孔Ø', unit: 'mm' }, { key: 'helix', label: '螺旋角β', unit: '°' }] },
  worm: { icon: 'worm', label: '蜗杆', param: '模数', field: 'module', unit: 'mm', fields: [{ key: 'module', label: '模数', unit: 'mm' }, { key: 'starts', label: '头数', unit: '' }, { key: 'length', label: '长度', unit: 'mm' }] },  // T770
  crowngear: { icon: 'crowngear', label: '冠齿轮', param: '模数', field: 'module', unit: 'mm', fields: [{ key: 'module', label: '模数', unit: 'mm' }, { key: 'teeth', label: '齿数', unit: '' }, { key: 'discH', label: '盘厚', unit: 'mm' }, { key: 'faceW', label: '齿宽', unit: 'mm' }, { key: 'bore', label: '孔Ø', unit: 'mm' }] },  // T770
  rack: { icon: 'rack', label: '齿条', param: '模数', field: 'module', unit: 'mm', fields: [{ key: 'module', label: '模数', unit: 'mm' }, { key: 'length', label: '长度', unit: 'mm' }, { key: 'baseH', label: '底座高', unit: 'mm' }, { key: 'thickness', label: '厚度', unit: 'mm' }] },
  pulley: { icon: 'pulley', label: 'V带轮', param: '外径', field: 'diameter', unit: 'mm', fields: [{ key: 'diameter', label: '外径', unit: 'mm' }, { key: 'width', label: '宽度', unit: 'mm' }, { key: 'bore', label: '中心孔Ø', unit: 'mm' }] },
  ...
  moveface: { icon: 'replaceface', label: '移动面', param: '距离', field: 'dist', unit: 'mm', fields: [{ key: 'mode', label: '模式', unit: '', opts: [{ value: 'offset', label: '偏移' }, { value: 'tilt', label: '倾斜' }] }, { key: 'dist', label: '距离', unit: 'mm' }, { key: 'angle', label: '倾斜角', unit: '°' }] },  // GM-B2：移动面 — 距离(offset)/倾斜角(tilt) 可改
