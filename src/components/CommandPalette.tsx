...
const SYN: Record<string, string> = {
  ...
  loft: '放样 过渡 渐变',
  sweep: '扫掠 沿路径 扫出',
  measureuni: '统一测量 量 尺寸 距离 面积 夹角 最短距 measure unified',
  measure: '量 尺寸 距离 测量 两点 ruler',
  measureedge: '量边 边长 孔径 直径 量孔',
  measureface: '量面 面积 表面',
  measureangle: '量角 角度 夹角',
  properties: '物理属性 质量 体积 惯性 质心 密度 properties mass',
  meshfacegroups: '网格面组 上色 面组 face groups',
  ...
  worm: '蜗杆 蜗轮 worm 大减速',
  crowngear: '冠齿轮 面齿轮 crown 垂直轴',
  pathpattern: '路径阵列 沿线复制',
  thread: '螺纹 牙 螺丝杆 螺杆 screw thread',
  gear: '齿轮 牙轮 正齿轮',
  rack: '齿条 直齿条',
  pulley: '皮带轮 带轮 V带',
