      ...
      <div className="help-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="help-grid" ref={gridRef}>
          <section>
            ...
            <p>圆角/倒角（可选顶/底/竖直/全部棱，复杂件自动回退可倒的棱）· 抽壳（先抽壳后倒角）· 拔模 · 缩放 · 合并/切割 · 分割实体 · 移动/复制（含绕 X/Y/Z 转）· 镜像 · 阵列。<br /><b>孔</b>：通孔 / 沉头 / 埋头（顶栏选孔型）。<br /><b>多截面放样</b>：在 XY/XZ/YZ 或任意参考面画轮廓→「＋放样截面」→选择下一个截面平面继续画→按加入次序「放样」。<br /><b>沿路径扫掠</b>：用折线/样条画开放路径→「沿路径扫掠」出圆管。</p>
          </section>
          <section>
            <h4>④ 装配 + 传动 + 机构</h4>
