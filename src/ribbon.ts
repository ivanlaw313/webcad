...
const SOLID: Panel[] = [
  {
    ...
    tools: [
      ...
      { id: 'createform', label: 'Create Form', icon: 'box', quick: true, tip: '切换到 Fusion 式 FORM 细分建模环境；完成后用 FINISH FORM 返回 SOLID。' },
...
export const FORM_PANELS: Panel[] = [
  { name: 'CREATE', tools: [
    { id: 'formsketch', label: 'Create Sketch', icon: 'sketch', quick: true },
    { id: 'formbox', label: 'Box', icon: 'box', quick: true },
    { id: 'formplane', label: 'Plane', icon: 'plane', quick: true },
    { id: 'formcyl', label: 'Cylinder', icon: 'cylinder', quick: true },
    { id: 'formsphere', label: 'Sphere', icon: 'sphere', quick: true },
    { id: 'formtorus', label: 'Torus', icon: 'torus' },
    { id: 'formquadball', label: 'Quadball', icon: 'sphere' },
    { id: 'formpipe', label: 'Pipe', icon: 'pipeicon' },
    { id: 'formface', label: 'Face', icon: 'plane', sep: true },
    { id: 'formextrude', label: 'Extrude', icon: 'extrude', sep: true },
    { id: 'formrevolve', label: 'Revolve', icon: 'revolve' },
    { id: 'formsweep', label: 'Sweep', icon: 'sweep' },
    { id: 'formloft', label: 'Loft', icon: 'loft' },
  ] },
  { name: 'MODIFY', tools: [
  ...
  { name: 'SYMMETRY', tools: [
    ...
    { id: 'formmirror', label: 'Mirror', icon: 'mirror' },
  ] },
  { name: 'UTILITIES', tools: [
    { id: 'formrepair', label: 'Repair Body', icon: 'param', quick: true },
  ] },
  { name: 'CONSTRUCT', tools: [
    { id: 'offsetplane', label: 'Offset Plane', icon: 'plane', quick: true },
  ] },
  { name: 'INSPECT', tools: [
    { id: 'measureuni', label: 'Measure', icon: 'measure', quick: true },
  ] },
  { name: 'INSERT', tools: [
    { id: 'forminsert', label: 'Insert Mesh', icon: 'insert', quick: true },
  ] },
  { name: 'SELECT', tools: [
    { id: 'select', label: 'Select', icon: 'select', quick: true },
  ] },
]
...
export const SKETCH_PANELS: Panel[] = [
  {
    ...
    tools: [
      ...
      { id: 'sk_earc', label: '椭圆弧', icon: 'cylinder', glyph: '◡', tip: '椭圆弧：中心 → 长轴端（定 rx+旋转）→ 短轴半径 → 起角 → 终角（逆时针）。真椭圆边，闭合成弓形可拉伸。' },
  ...
  },
  {
    ...
    tools: [
      ...
      { id: 'sk_c_tan', label: '相切', icon: 'default', glyph: '⌒', quick: true, tip: '相切：用「选择」工具点 1 条直线 + 1 个圆（或 2 个圆 / 圆弧）→ 撳此 → 求解器令佢哋同圆外径相切贴合并锁住。想画线时即时相切：用「直线」由上一点拉向圆，会自动吸住切点（snap）。' },
