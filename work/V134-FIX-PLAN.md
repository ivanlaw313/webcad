...
## Acceptance
- [x] Spatial chain: 20k disconnected LINEs parse ≪ 1s (~125ms)
- [x] AL1: prefer/force sketchOnly heuristics correct; markers ≤128; labels retained
- [x] Double-parse eliminated on dialog confirm path
- [x] Contract suite PASS; Shell v1.28–v1.33 + illegal-UX still PASS
- [x] LIVE 1.34 verified (`v1.34-20260918-230425`)
