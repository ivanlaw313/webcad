...
const META: Record<string, { icon: string; label: string; param: string; field: string; unit: string; fields?: FieldDef[] }> = {
  ...
  sheetmetal: { icon: 'sheetmetal', label: '钣金件', param: '厚度', field: 'thickness', unit: 'mm', fields: [{ key: 'thickness', label: '厚度', unit: 'mm' }, { key: 'radius', label: '折弯半径', unit: 'mm' }, { key: 'kfactor', label: 'K因子', unit: '' }, { key: 'width', label: '宽度', unit: 'mm' }, { key: 'flat', label: '状态', unit: '', opts: [{ value: '0', label: '折叠' }, { value: '1', label: '展开' }] }] },
  ...
  rib: { icon: 'rib', label: '加强筋', param: '厚度', field: 'thickness', unit: 'mm', fields: [{ key: 'thickness', label: '厚度', unit: 'mm' }, { key: 'height', label: '高度', unit: 'mm' }, { key: 'baseZ', label: '基准Z', unit: 'mm' }, { key: 'draft', label: '拔模', unit: '°' }] },
